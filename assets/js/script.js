        ...
        function setupPWAInstall() {
            ...
            // 2. Evento para capturar el prompt de instalación
            window.addEventListener('beforeinstallprompt', (e) => {
                e.preventDefault();
                deferredPrompt = e;
                installBanner.classList.remove('hidden'); // Muestra el banner personalizado
            });

            // 3. Listener para el botón de 'Instalar'
            ...
            // 4. Listener para el botón de 'Ignorar'
            dismissBtn.addEventListener('click', () => {
                installBanner.classList.add('hidden');
            });

            // 5. Ocultar el banner si la app ya está instalada
